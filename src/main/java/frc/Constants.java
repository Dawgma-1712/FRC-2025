...
public class Constants {
    public static class OperatorConstants {
        ...
        // Pose2d(3.231,4.010,Rotation2d.fromDegrees(-56.135));
        // public static final Pose2d blueCRAlgae = new
        // Pose2d(3.862,2.943,Rotation2d.fromDegrees(125.341));
        // public static final Pose2d blueCLAlgae = new
        // Pose2d(3.847,5.077,Rotation2d.fromDegrees(-72.255));
        // public static final Pose2d blueFMAlgae = new
        // Pose2d(5.725,4.025,Rotation2d.fromDegrees(-109.185));
        // public static final Pose2d blueFRAlgae = new
        // Pose2d(5.094,2.943,Rotation2d.fromDegrees(158.949));
        // public static final Pose2d blueFLAlgae = new
        // Pose2d(5.109,5.107,Rotation2d.fromDegrees(136.755));
        ...
        public static final Pose2d redCRAlgae = new Pose2d(17.53 - 3.862, 8.03 - 2.943,
                Rotation2d.fromDegrees(180 + 60));
        public static final Pose2d redCLAlgae = new Pose2d(17.53 - 3.847, 8.03 - 5.077,
                Rotation2d.fromDegrees(180 - 60));
        public static final Pose2d redFMAlgae = new Pose2d(17.53 - 5.725, 8.03 - 4.025, Rotation2d.fromDegrees(0));
        public static final Pose2d redFRAlgae = new Pose2d(17.53 - 5.094, 8.03 - 2.943,
                Rotation2d.fromDegrees(180 - 60));
        public static final Pose2d redFLAlgae = new Pose2d(17.53 - 5.109, 8.03 - 5.107,
                Rotation2d.fromDegrees(180 + 60));

        public static final Pose2d blueProcessor = new Pose2d(5.975, 0.570, Rotation2d.fromDegrees(-90));
        public static final Pose2d redProcessor = new Pose2d(17.53 - 5.975, 8.03 - 0.570,
                Rotation2d.fromDegrees(180 + 90));

        // Constraints constant:
        public static final PathConstraints testingConstraints = new PathConstraints(.3, .4, Units.degreesToRadians(54),
                Units.degreesToRadians(72));
        public static final PathConstraints gameConstraints = new PathConstraints(3, 4, Units.degreesToRadians(540),
        ...
        public static final double[] aprilTagX = {
                467.64, 469.11, 445.35, 445.35, 469.11, 467.64, 470.59, 483.11,
                158.34, 492.88, 483.11, 470.59, 650.92, 650.92, 650.90, 650.90,
                183.59, 182.11, 205.87, 205.87, 182.11, 183.59, 180.64, 168.11,
                158.34, 158.34, 168.11, 180.64, 0.30, 0.30, 0.32, 0.32
        };
        public static final double[] goalX = { -12, -12, -12, -12, -12, -12, 12, 12, -12, -12, -12, -12, -12, -12, -12,
                -12 };
        public static final double[] aprilTagY = {
                292.31, 182.60, 172.84, 158.84, 135.09, 25.37, 25.37, 135.09,
                144.84, 158.84, 182.60, 292.31, 291.47, 274.47, 170.22, 153.22,
                25.37, 135.09, 144.84, 158.84, 182.60, 292.31, 292.31, 182.60,
                172.84, 158.84, 135.09, 25.37, 26.22, 43.22, 147.47, 164.47
        };
        public static final double[] aprilTagZ = {
                35.00, 44.25, 44.25, 44.25, 44.25, 35.00, 35.00, 44.25,
                44.25, 44.25, 44.25, 35.00, 21.75, 21.75, 21.75, 21.75,
                35.00, 44.25, 44.25, 44.25, 44.25, 35.00, 35.00, 44.25,
                44.25, 44.25, 44.25, 35.00, 21.75, 21.75, 21.75, 21.75
        };
        public static final double[] aprilTagYaw = {
                180.0, 90.0, 180.0, 180.0, 270.0, 180.0, 0.0, 270.0,
                0.0, 0.0, 90.0, 0.0, 180.0, 180.0, 180.0, 180.0,
                0.0, 270.0, 0.0, 0.0, 90.0, 0.0, 180.0, 90.0,
                180.0, 180.0, 270.0, 180.0, 0.0, 0.0, 0.0, 0.0
        };
        ...
        public static final Transform3d LIMELIGHT_TO_ROBOT = new Transform3d(new Translation3d(0.4, 0, 0.3),
                new Rotation3d());
        public static final double LIMELIGHT_HORIZONTAL_FOV = 60.2; // in degrees
        public static final double LIMELIGHT_VERTICAL_FOV = 48.9; // in degrees
        public static final double INCHES_PER_METER = 39.37;
        public static final double LIMELIGHT_RANGE = 5.0;
    }
}
