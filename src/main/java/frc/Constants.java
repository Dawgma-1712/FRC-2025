...
public class Constants {
    public static class OperatorConstants {
        ...
        public static final double[] aprilTagX = { 657.37, 657.37, 455.15, 365.20, 365.20, 530.49, 546.87, 530.49,
                497.77, 481.39, 497.77, 33.51, 33.51, 325.68, 325.68, 235.73, 160.39, 144.00, 160.39, 193.10, 209.49,
                193.10 };
        public static final double[] goalX = { -12, -12, -12, -12, -12, -12, 12, 12, -12, -12, -12, -12, -12, -12, -12,
                -12 };
        public static final double[] aprilTagY = { 25.8, 291.2, 317.15, 241.64, 75.39, 130.17, 158.5, 186.83, 186.83,
                158.5, 130.17, 25.8, 291.2, 241.64, 75.39, -0.15, 130.17, 158.5, 186.83, 186.83, 158.5, 130.17 };
        public static final double[] aprilTagZ = { 58.5, 58.5, 51.25, 73.54, 73.54, 12.13, 12.13, 12.13, 12.13, 12.13,
                12.13, 58.5, 58.5, 73.54, 73.54, 51.25, 12.13, 12.13, 12.13, 12.13, 12.13, 12.13 };
        public static final double[] aprilTagYaw = { 126, 234, 270, 0, 0, 300, 0, 60, 120, 180, 240, 54, 306, 180, 180,
                90, 240, 180, 120, 60, 0, 300 };
        ...
        public static final Transform3d LIMELIGHT_TO_ROBOT = new Transform3d(new Translation3d(0.5, 0, 0.5),
                new Rotation3d());
